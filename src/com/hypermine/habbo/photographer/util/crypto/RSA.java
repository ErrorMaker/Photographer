...
class RSA
{
    ...
    public BigInteger Decrypt(String value) {
         ...
         BigInteger paddedInteger = DoPrivate(signed);

//         byte[] value = paddedInteger.toByteArray();
         byte[] valueData = pkcs1unpad2(paddedInteger, GetBlockSize());
         return new BigInteger(valueData);
    }

    public BigInteger Decrypt2(String ctext)
    {
